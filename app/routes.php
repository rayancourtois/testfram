...
use App\Application\Actions\Admin\ListCitoyenActionAdmin;
...
return function (App $app) {
    ...
    $app->get('/', function (Request $request, Response $response) {
        $response->getBody()->write('Bienvenue sur la plus belle API du monde!');
        return $response;
    });
    ...
    $app->post('/agent/inscription', RegisterAgentAction::class);
    ...
    $app->get('/admin/citoyen', ListCitoyenActionAdmin::class);
